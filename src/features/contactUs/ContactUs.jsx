...
import { Clock, Envelope, Facebook, Globe, Instagram, Map, Phone, Whatsapp } from "react-bootstrap-icons";
...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const success = true; // Cambia questo in base al risultato effettivo
    ...
    if (success) {
      ...
      setAlertMessage("Si è verificato un errore durante l'invio del messaggio.");
    }
